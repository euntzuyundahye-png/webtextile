...
<div class="form-card">
    ...
    <form action="{{ route('stok-masuk.update', $stokMasuk->id) }}"
          method="POST">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="supplier"
                    class="form-control"
                    value="{{ old('supplier', $stokMasuk->supplier) }}">
            ...
            <div class="form-group full-width">
                ...
                <textarea
                    name="keterangan"
                    rows="5"
                    class="form-control">{{ old('keterangan', $stokMasuk->keterangan) }}</textarea>
